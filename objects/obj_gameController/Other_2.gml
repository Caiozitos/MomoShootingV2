...
if !file_exists(working_directory + "itemsGlobal.ini") {
	#region Lista de itens
		var globalItemList = [
	"{ \"itemId\": 1, \"name\": \"Apple\", \"itemType\": \"Item\", \"cost\": 25, \"desc\": \"The shinier, the better... or so they say. Just dont think too hard about the wax they use to make it shine.\", \"descEffect\": \"+3 Max Health\\n+2 Health (Heal)\", \"synergy\": [] }",
	"{ \"itemId\": 2, \"name\": \"Coffee\", \"itemType\": \"Item\", \"cost\": 30, \"desc\": \"Gets me hyped! Though its probably the sugar overload more than the caffeine kick.\", \"descEffect\": \"+20% Shooting Speed\\n+15% Movement Speed\", \"synergy\": [] }",
	"{ \"itemId\": 3, \"name\": \"Light Bulb\", \"itemType\": \"Item\", \"cost\": 20, \"desc\": \"Staring at it is bad enough. Dont even try to guess what itll do to your eyes when it explodes.\", \"descEffect\": \"Shooting or touching the Light Bulb causes it to explode, blinding all nearby enemies for 5 seconds.\", \"synergy\": [] }",
	...
	"{ \"itemId\": 5, \"name\": \"Lighter\", \"itemType\": \"Item\", \"cost\": 30, \"desc\": \"Not really effective due to its short range. But what if I had something flammable?\", \"descEffect\": \"Enemies that touch you will be burned. Youre still taking damage from them, though.\", \"synergy\": [\"Deodorant\"] }",
	"{ \"itemId\": 6, \"name\": \"Bangbang\", \"class\": \"Pistol\", \"itemType\": \"Gun\", \"cost\": 50, \"desc\": \"Ive been using this fella for years now. It was my first pistol... Not bad, but there are definitely better ones.\", \"descEffect\": \"Shoots normal bullets with high precision and solid damage. Pretty fast fire rate.\", \"synergy\": [] }",
	...
	"{ \"itemId\": 9, \"name\": \"BCK-2U\", \"class\": \"Pistol\", \"itemType\": \"Gun\", \"cost\": 75, \"desc\": \"I dont really get how is it possible to bullets to bounce. Is this what people call a stray bullet?\", \"descEffect\": \"Bullets ricochet once after hitting a wall.\\nRicochets increase damage by 40%.\", \"synergy\": [] }",
	"{ \"itemId\": 10, \"name\": \"Hexcrash\", \"class\": \"Pistol\", \"itemType\": \"Gun\", \"cost\": 75, \"desc\": \"Someone once said six bullets are enough to show off the Wests fastest trigger. I live in the South, though.\", \"descEffect\": \"Fires slowly. Each shot increases damage by 5%,\\nresetting at 30%. The sixth shot is always a critical.\", \"synergy\": [] }"
];
